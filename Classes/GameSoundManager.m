...
//NOTE: Added My game's sound effects.	
    ...
    //Preloading our sound effects.
	
	[soundEngine_ preloadEffect:@"warpElectrocute.aif"];	
	[soundEngine_ preloadEffect:@"warpGameStartSelect.aif"];		
	[soundEngine_ preloadEffect:@"warpGetKey.aif"];
	[soundEngine_ preloadEffect:@"warpJump.aif"];
	[soundEngine_ preloadEffect:@"warpLevelFinish.aif"];
    [soundEngine_ preloadEffect:@"warpPlayerWalk.aif"];
    [soundEngine_ preloadEffect:@"warpYell.aif"];
    [soundEngine_ preloadEffect:@"warpBlade.aif"];
    [soundEngine_ preloadEffect:@"warpPlatformStep.aif"];
    [soundEngine_ preloadEffect:@"enterTheMaze.aif"];
    
    
	
//Preloading the background music too.
	//However, there is no point in preloading multiple background music files so only
	//preload the first one you will play.
	
	[soundEngine_ preloadBackgroundMusic:@"backgroundTune1.mp3"];
    [soundEngine_ preloadBackgroundMusic:@"backgroundTune2.mp3"];
    
    [soundEngine_ preloadBackgroundMusic:@"endingTheme.mp3"];
    [soundEngine_ preloadBackgroundMusic:@"creditsBeat.mp3"];
}	

//I ended up not using this, but may do so later.
	//-(void) fadeOutMusic {
